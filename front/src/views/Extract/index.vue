  ...
  <div class="flex h-screen flex-col gap-6 p-8 text-white">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        <Button @click="loadArchives" :disabled="loading || extracting">刷新扫描</Button>
        <Button
          type="primary"
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      ...
      <div class="rounded-2xl border border-neutral-700/70 bg-neutral-900/70 p-4">
        ...
        <div class="mt-2 text-xs text-neutral-400">默认只处理判定为待解压的压缩包。</div>
      </div>
      <div class="rounded-2xl border border-neutral-700/70 bg-neutral-900/70 p-4">
    ...
    <div class="flex-1 overflow-auto rounded-2xl border border-neutral-700/70 bg-neutral-900/60">
      ...
      <div v-else-if="!scanResult?.roots?.length" class="flex h-72 items-center justify-center text-sm text-neutral-400">
